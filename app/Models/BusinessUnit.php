...
class BusinessUnit extends Model
{
    ...
    public static function validationRules(): array
    {
        return [
            ...
            'company_stats.*.label' => 'sometimes|required|string|max:255',
            'company_stats.*.value' => 'sometimes|required|string|max:100',
            'company_stats.*.icon' => 'sometimes|nullable|string|max:100',
