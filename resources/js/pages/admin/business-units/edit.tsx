        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Edit Unit Bisnis: {businessUnit.name}</h1>
                        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Perbarui informasi unit bisnis</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-3">
                        ...
                        <Button type="submit" disabled={processing}>
                            ...
                            {processing ? 'Menyimpan...' : 'Perbarui Unit Bisnis'}
                        </Button>
                    </div>
                </form>
            </div>
