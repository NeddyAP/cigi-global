        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Edit Komunitas</h1>
                        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Edit informasi komunitas {communityClub.name}</p>
                    </div>
